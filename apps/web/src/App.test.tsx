...
const packs: CountryPack[] = [
  ...
  },
  {
    ...
    live_submission_supported: false,
    official_artefact_validation: "not_configured",
    legal_regime_summary: "UK readiness pack.",
    scope: ["UK mandatory e-invoicing is planned for 2029."],
    mandatory_format: ["UK readiness XML only."],
    transmission_or_clearance_model: ["No live Peppol transmission."],
    qr_signature_requirements: ["No QR configured."],
    retention_or_audit_notes: ["Readiness evidence only."],
    v1_app_capability: ["Readiness XML generation only."],
    official_sources: [{ label: "Deferred scope", url: "docs/14_open_items_and_deferred_scope.md" }],
    regime_summary: "UK readiness scaffold.",
    legal_invoice_requirements: ["GB parties and Peppol endpoints required."],
    einvoice_requirements: ["Readiness XML only."],
    source_status: ["No artefacts configured."],
    boundary_highlights: ["No final UK compliance claim."],
